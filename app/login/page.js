  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <main className="relative z-20 flex min-h-screen items-center justify-center px-6 py-20">
        <div className="w-full max-w-md rounded-[2rem] border border-white/15 bg-white/[0.08] p-8 shadow-[0_25px_100px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-2xl">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-4 h-14 w-14 rounded-2xl bg-gradient-to-br from-[#5227FF] via-[#FF9FFC] to-[#e59745] shadow-[0_0_40px_rgba(255,159,252,0.45)]" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/10 bg-black/35 px-4 py-3 text-white outline-none transition-all duration-300 placeholder:text-zinc-500 focus:border-pink-300/60 focus:bg-black/50 focus:shadow-[0_0_30px_rgba(255,159,252,0.18)]"
              />
            </div>
            ...
            <div>
              <div className="mb-2 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-xs font-semibold text-pink-200 transition hover:text-white hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full rounded-2xl border border-white/10 bg-black/35 px-4 py-3 text-white outline-none transition-all duration-300 placeholder:text-zinc-500 focus:border-purple-300/60 focus:bg-black/50 focus:shadow-[0_0_30px_rgba(82,39,255,0.22)]"
              />
            </div>
