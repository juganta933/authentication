...
export default function Error({ error, reset }) {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-6 text-white">
      ...
      <main className="relative z-20 w-full max-w-md rounded-[2rem] border border-white/15 bg-white/[0.08] p-8 text-center shadow-[0_25px_100px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-2xl">
        <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-red-500/20 text-3xl font-black text-red-200 shadow-[0_0_40px_rgba(248,113,113,0.35)]">
          !
        </div>

        <h1 className="bg-gradient-to-r from-white via-red-200 to-pink-300 bg-clip-text text-3xl font-black tracking-tight text-transparent">
