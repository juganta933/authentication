      ...
      <main className="relative z-20 flex min-h-screen items-center justify-center px-6 py-20">
        <div className="w-full max-w-md rounded-[2rem] border border-white/15 bg-white/[0.08] p-8 shadow-[0_25px_100px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-2xl">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#5227FF] via-[#FF9FFC] to-[#e59745] text-2xl font-black shadow-[0_0_40px_rgba(255,159,252,0.45)]">
              ?
            </div>
